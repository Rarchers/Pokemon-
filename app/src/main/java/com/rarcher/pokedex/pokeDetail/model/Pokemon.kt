...
data class Pokemon (
        ...
        fun color(): Color {
                ...
                return when (type?.toLowerCase(Locale.ROOT)) {
                        "grass", "bug" -> poke_light_teal
                        "fire" -> poke_light_red
                        "water", "fighting", "normal" ->poke_light_blue
                        "electric", "psychic" -> poke_light_yellow
                        "poison", "ghost" -> poke_light_purple
                        "ground", "rock" -> poke_light_brown
                        "dark" -> poke_black
                        else -> return poke_light_blue
                }
        }
}
...
val pokemons = listOf(
        Pokemon(
                id = "#001",
                name = "妙蛙种子",
                description = "在明亮的阳光下可以看到妙蛙种子在打盹。它背上有一粒种子。通过吸收阳光，种子逐渐长大.",
